...
contract HelperConfig is Script {
    ...
    uint256 public DEFAULT_ANVIL_PRIVATE_KEY = vm.envUint("LOCAL_PRIVATE_KEY");
    ...
    function getMainnetEthConfig() public view returns (NetworkConfig memory mainnetNetworkConfig) {
        mainnetNetworkConfig = NetworkConfig({
            ...
            automationUpdateInterval: 86400, // 1 day
    ...
    function getSepoliaEthConfig() public view returns (NetworkConfig memory sepoliaNetworkConfig) {
        sepoliaNetworkConfig = NetworkConfig({
            subscriptionId: 4057, // If left as 0, our scripts will create one!
